...
get_handle ( int fd, u_int expected_id, u_int *len )
{
	...
	handle = ( char* ) buffer_get_string ( &msg, len );
	buffer_free ( &msg );
			...
			do_init ( int fd_in, int fd_out, u_int transfer_buflen, u_int num_requests )
{
	...
	ret = ( struct sftp_conn* ) xmalloc ( sizeof ( *ret ) );
	ret->fd_in = fd_in;
	ret->fd_out = fd_out;
               ...
               SFTP_DIRENT ***dir )
{
	...
	{
		ents = 0;
		*dir = ( SFTP_DIRENT** ) xmalloc ( sizeof ( **dir ) );
		( *dir ) [0] = NULL;
	}
	...
	for ( ; !interrupted; )
	{
		...
		for ( i = 0; i < count; i++ )
		{
			...
			filename = ( char* ) buffer_get_string ( &msg, NULL );
			longname = ( char* ) buffer_get_string ( &msg, NULL );
			a = decode_attrib ( &msg );
			...
			if ( dir )
			{
				*dir = ( SFTP_DIRENT** ) xrealloc ( *dir, ents + 2, sizeof ( **dir ) );
				( *dir ) [ents] = ( SFTP_DIRENT* ) xmalloc ( sizeof ( ***dir ) );
